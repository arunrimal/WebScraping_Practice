...
def to_string(s):
    ...
    try:
        print('inside try.printing str(s).. : ',str(s))
        print()
        return str(s)
        
    except:
        print('inside except.printing s.encode.. : ', s.encode('utf-8'))
...
def travel_element_json(row_dict, key, value):
    ...
    :return:
    """
    print('inside travel_element_json()...: ', row_dict, key, value)
    ...
    # Reduction Condition 2
        ...
        sub_keys = value.keys()    # to find the key of disctionary
        print('checking sub_keys: ',sub_keys)
        for sub_key in sub_keys:  
            ...
            if(sub_key!='talemetry_job_id' and sub_key!='permalink' and sub_key!='region_abbr' and sub_key!='phone' and sub_key!='email' and sub_key!='extra' and sub_key!='name'):
                ...
                #print('xyz',row_dict, sub_key, value[sub_key])
    ...
    # Base Condition
        ...
        if key not in row_dict.keys():
            ...
            print('inside base condition, if not in row_dict.keys(),.... :', row_dict[to_string(key)], to_string(value))

        else:
            row_dict[to_string(key)] = row_dict[to_string(key)] + '||' + value
            print('inside base condition else: ',row_dict[to_string(key)], row_dict[to_string(key)] + '||' + value )

    print('return of json_travel_element: ', row_dict)
    return row_dict
...
def parse_from_root(each_item, total_element, input_file_type, element):
    ...
    row_dict = {}
    print('printing row_dict of parse_from_root:', row_dict)
    ...
    if input_file_type == 'json':
        ...
        print('printing row_dict inside if of parse_from_root: ', row_dict)

    print(">>>  Progress:  {} %   ".format(int((counter/total_element)*100)), end='\r')
    sys.stdout.flush()
    counter += 1
    dict_list.append(row_dict)
    print('printing dict_list inside of parse_from_root: ', dict_list)
...
class ProducerThread(Thread):
    ...
    def run(self):
        ...
        while self.element_list:
            ...
            print('printing each_item of while loop in producer thread: ', each_item)
            queue.put(each_item)
            print('putting each_item in queue: ', queue)
...
class ConsumerThread(Thread):
    ...
    def run(self):
        ...
        while not queue.empty():
            each_item = queue.get()
            print('printing each_item of while loop in consumer thread run(): ', each_item), print('calling parse_from_root() from while loop in consumer thread run()...')
...
def parseJson(data):
    ...
    consumer_thread_list = [ConsumerThread(total_element, 'json', 'entries') for x in range(2)]
    ...
    for each_consumer in consumer_thread_list:
        print('each_consumer before start in main function: ', each_consumer)
        each_consumer.start()
        print('each_consumer after start in main function: ', each_consumer), print('each_consumer after start in main function ends')
    print('...........................................................consumer thread list .....................................................................end!!!')
    print('.......................................................producer thread list for join..............................................................start!!! ') 
    for each_producer in producer_thread_list:
        print('each_producer before join in main function: ', each_producer)
        each_producer.join()
        print('each_producer after join in main function: ', each_producer), print('each_producer after join in main function ends')
    print('.......................................................producer thread list for join.................................................................end!!! ') 
    print('........................................................consumer thread list for join..............................................................start!!! ')
    for each_consumer in consumer_thread_list:
        print('each_consumer before join in main function: ', each_consumer)
        each_consumer.join()
    print('each_consumer after join in main function: ', each_consumer),  print('each_consumer after join in main function ends')
...
exeloncorp_start(current_page =1,perpage=1)
